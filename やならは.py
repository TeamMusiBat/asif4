...
admin =['u98b7155ec2d725ca1817dc64834dd39e',clMID]
owners = [""]
...
#==============================================================================#
            if sender in K0 or sender in owners:
                if text.lower() == 'help':
                    ...
                    cl.sendContact(to,"u98b7155ec2d725ca1817dc64834dd39e")
                elif text.lower() == 'bye':
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner ="u98b7155ec2d725ca1817dc64834dd39e"
...
#==============================================================================#
                    ...
                    cl.sendContact(to,"u98b7155ec2d725ca1817dc64834dd394")
                if text.lower() == 'ヘルプ':
