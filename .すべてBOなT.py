...
admin =['ubdfdbe777c1ef100e4e51485c42cb5e5','uc1c972e5f7e3129388af1c4042e33f5c',clMID]
owners = ["ubdfdbe777c1ef100e4e51485c42cb5e5"]
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner ="ubdfdbe777c1ef100e4e51485c42cb5e5"
...
#==============================================================================#
                    ...
                    cl.sendContact(to,"ubdfdbe777c1ef100e4e51485c42cb5e5")
                if text.lower() == 'ヘルプ':
                    cl.sendFile(to,"help.py")
                    cl.sendContact(to,"ubdfdbe777c1ef100e4e51485c42cb5e5")
                    
                elif text.lower() == '購入':
                    cl.sendMessage(to, "ソース購入\n体験\n4ヶ月\n8ヶ月\n1年\n永遠\n⬆\nが\nあ\nり\nま\nす\n購入希望の方は\n ____⬇____\n⬇⬇⬇⬇⬇")
                    cl.sendContact(to,"ubdfdbe777c1ef100e4e51485c42cb5e5")
...
#==============================================================================#
                    ...
                    if admin == [u4a7e82cd5197203874d8bbb73dc12b17]:
...
#==============================================================================#
                elif text.lower() == 'ログイン':

                    ll = LINE()
                ll.log("Auth Token : " + str(cl.authToken))


                cl.sendMessage(to, ll.authToken)
